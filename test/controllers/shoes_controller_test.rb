...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { description: @shoe.description, title: @shoe.title, user_id: @shoe.user_id }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { description: @shoe.description, title: @shoe.title, user_id: @shoe.user_id }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
